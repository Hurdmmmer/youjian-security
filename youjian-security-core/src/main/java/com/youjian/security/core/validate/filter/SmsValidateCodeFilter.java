...
public class SmsValidateCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    public void afterPropertiesSet() throws ServletException {
        ...
        urls.add("/authentication/mobile"); // 配置基本的短信拦截
    }
    ...
    private void validate(ServletWebRequest request) throws ValidateCodeException {
        // session 取出验证码
        ValidateCode smsCode = (ValidateCode) sessionStrategy.getAttribute(request, ValidateCodeProcessor.SESSION_KEY_PREFIX + "SMS");
        // 请求中获取验证码
        ...
        if (!StringUtils.equalsAnyIgnoreCase(codeInRequest, smsCode.getCode())) {
